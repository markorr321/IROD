function GetIntuneRemediationResults {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        GetIntuneRemediationResults -RemediationName "Fix Disk Space" -CsvPath "C:\Reports\remediation.csv"
        Retrieves results for the "Fix Disk Space" remediation and saves to the specified CSV file.

    .EXAMPLE
        GetIntuneRemediationResults -RemediationName "Update Registry" -CsvPath ".\results.csv"
        Retrieves results and saves to the specified CSV file.
    #>
